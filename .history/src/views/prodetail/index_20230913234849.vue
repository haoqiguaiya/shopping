...
export default {
  ...
  methods: {
    ...
    async getDetail () {
      ...
      this.detail = detail
      this.skuId = detail.skuList[0].goods_sku_id
      this.images = detail.goods_images
      console.log(detail.skuList[0].goods_sku_id)
    },
    async getComment () {
      const { data: { total, list } } = await getProComments(this.goodsId, this.limit, this.skuId)
      this.total = total
